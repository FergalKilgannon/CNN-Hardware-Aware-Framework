...
class forwardPass(hardware):
    ...
    def forward_pass(self, data, batch):
        ...
        x = self.conv2d(x, batch, self.model.conv1.module, s_in, padding=1)
        # ReLU 1
        ...
        x = self.conv2d(x, batch, self.model.conv2.module, sin_conv2, padding=1)
        # ReLU 2
        ...
        x = self.conv2d(x, batch, self.model.conv3.module, sin_conv3, padding=1)
        # ReLU 3
        ...
        x = self.conv2d(x, batch, self.model.conv4.module, sin_conv4, padding=1)
        # ReLU 4
        x = self.relu6(x, self.model.relu4.module)
        # Maxpool layer 2
        x = self.maxpool2d(x, batch, 2)
        ...
        x = self.conv2d(x, batch, self.model.conv5.module, sin_conv5, padding=1)
        # ReLU 5
        x = self.relu6(x, self.model.relu5.module)
        ...
        x = self.conv2d(x, batch, self.model.conv6.module, sin_conv6, padding=1)
        # ReLU 6
        x = self.relu6(x, self.model.relu6.module)
        # Maxpool layer 3
        x = self.maxpool2d(x, batch, 2)
        ...
        # ReLU 7
        x = self.relu6(x, self.model.relu7.module)
